...
- [Grocery Express](https://github.com/wenwenli6/GroceryExpress) 
    - Frontend: Thymeleaf
    - Backend: Spring Boot, Spring Security, MySQL, Redis, Java
- [Todo-Management](https://github.com/wenwenli6/Todo_Management_APP) 
    - Frontend: React
...
<!--
**wenwenli6/wenwenli6** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
